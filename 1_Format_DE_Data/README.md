...
## Method
I ran the **clean_facs_data.R** script to clean and score sequence variants for downstream modeling. Sequencing data used in this study are provided in the "Source" directory.
