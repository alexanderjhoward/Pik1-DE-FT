...
5. [Model NUDT15 data](https://github.com/alexanderjhoward/Pik1-DE-FT/tree/main/6_Visualize_Results): Recapitulate our genotype-to-phenotype approach with another dataset (NUDT15 enzyme functionality).
